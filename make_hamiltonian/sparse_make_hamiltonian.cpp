                             ...
                             double *mat_val, int &coo_index)
{
    ...
    if (Boundary_Condition == "y")
    {
        for (int j = 0; j < mat_dim; j++)
        {
            ...
            {
                szz(j, site_num, tot_site_num, J, row, col, mat_val, coo_index);
                spm(j, site_num, tot_site_num, J, row, col, mat_val, coo_index);
                smp(j, site_num, tot_site_num, J, row, col, mat_val, coo_index);
            }
            coo_index++;
        }
    }
